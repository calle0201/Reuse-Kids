...
class Martialart extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/martialart.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
        ...
        render() {
            ...
            return (
                <div>
                     <Helmet>
                        <title>Begagnad kampbarn produkter </title>
                        <meta name="description" content="Webbsida för begagnad judodräkt, ankelstöd, taekwondo dobok, benskydd, kläder och JJ-handske." />
                    </Helmet>
                <h1 className="Advertisment_title">Kampsport</h1>
                <h3 className="Advertisment_subtitle">Här finns det kampsportsutrustning som dräkter och skydd. Är sidan tom finns det inga annonser för tillfället.</h3>
