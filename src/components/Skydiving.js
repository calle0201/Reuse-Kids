...
class Skydiving extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/skydiving.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
        ...
        render() {
            ...
            return (
                <div>
                     <Helmet>
                        <title>Begagnad fotbollsutrustning </title>
                        <meta name="description" content="Webbsida för begagnad rigg, kalott, bag, dytter, pilotskärm, vingoverall, overall och slider." />
                    </Helmet>
                <h1 className="Advertisment_title">Fallskärmshoppning</h1>
                <h3 className="Advertisment_subtitle">Här finns det fallskärmsutrustning som skärmar, riggar, och overaller. Är sidan tom finns det inga annonser för tillfället.</h3>
