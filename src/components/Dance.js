...
class Dance extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/dance.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
        ...
        render() {
            ...
            return (
                <div>
                     <Helmet>
                        <title>Begagnad dansutrustning </title>
                        <meta name="description" content="Webbsida för begagnade danskläder, dansskor, balettskor, flamenco, jazzdans, balett, knäskydd" />
                    </Helmet>
 
                <h1 className="Advertisment_title">Dance</h1>
                <h3 className="Advertisment_subtitle">Här finns det dansutrustning som skor och kläder. Är sidan tom finns det inga annonser för tillfället.</h3>
