...
class Waterskiing extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/waterskiing.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
    ...
    render() {
      return (
        <div>
             <Helmet>
                <title>Begagnad vattenskidsutrustning </title>
                <meta name="description" content="Webbsida för begagnade vattenskidor, skärmar, bindningar, våtdräkter, linor, handtag, flytväst, hjälmar och handskar." />
            </Helmet>
            <h1 className="Advertisment_title">Vattenskidor</h1>
            <h3 className="Advertisment_subtitle">Här finns det vattenskidsutrustning som vattenskidor, wakeboards, flytvästar och skyddsutrustning. Är sidan tom finns det inga annonser för tillfället.</h3>
