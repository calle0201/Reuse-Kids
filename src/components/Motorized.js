...
class Motorized extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/motorized.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
        ...
        render() {
            ...
            return (
                <div>
                     <Helmet>
                        <title>Begagnad motorbarn produkter </title>
                        <meta name="description" content="Webbsida för begagnade rallykläder, nackkrage, rallyhjälm, bälteskniv och skydd." />
                    </Helmet>
                <h1 className="Advertisment_title">Motorsport</h1>
                <h3 className="Advertisment_subtitle">Här finns det utrustning som kläder, hjälmar, reservdelar och skydd. Är sidan tom finns det inga annonser för tillfället.</h3>
