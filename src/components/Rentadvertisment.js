...
class Rentadvertisment extends Component {
    constructor(props) {
        super(props);
        this.state = {
            title: "",
 ...
 /*   handleSport(event) {
    ...
    handleSubmit(event) {
        ...
        fetch('https://reusesport.se/APIs/rentadvertisment.php', {
            method: 'POST',
      ...
      fetch('https://reusesport.se/APIs/getrentid.php', {
          method: 'POST',
          headers: h,
          body: (imagedata)
      })
  ...
  render() {
    ...
    return (
        <div className="Sell"> 
            <div className="Sell-picture">
                ...
                <div className="Sell-Box">
                    <div className="Sell-innerbox">
                        <h1 className="Sell-title">Har du barn produkter som inte används så ofta?</h1> 
                        <h2 className="Sell-intro">Då passar det väldigt bra att hyra ut den till någon som behöver den för en kortare period.</h2>
            ...
            <div className="Rentadvertisment-Footer_position">
            </div>
            <Footer />
...
export default Rentadvertisment;