...
class Windsurfing extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/windsurfing.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
    ...
    render() {
      return (
        <div>
             <Helmet>
                <title>Begagnad vindsurfingsutrustning </title>
                <meta name="description" content="Webbsida för begagnade vindsurfingbrädor, vindsurfingsegel, master, bommar och våtdräkt." />
            </Helmet>
            <h1 className="Advertisment_title">Vindsurfing</h1>
            <h3 className="Advertisment_subtitle">Här finns det vindsurfingutrustning som brädor, våtdräkter, segel och tillbehör. Är sidan tom finns det inga annonser för tillfället.</h3>
