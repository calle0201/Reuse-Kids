      ...
      render() {
        return (
          <div className="MailRecipe">
            ...
            <div className="MailRecipe_title">Ladda ner tips på hur du undviker skador. </div>
            <form className="MailRecipe_form" onSubmit={this.handleSubmit}> 
                ...
                <div className="MailRecipe_button">
                    <input className="MailRecipe_submit" type="submit" value="Ja jag vill gärna ha tipsen" />
                </div>
            </form>
