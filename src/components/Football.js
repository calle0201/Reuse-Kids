...
class Football extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/football.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
      ...
      return (
        <div>
             ...
             <Helmet>
                ...
                <meta name="description" content="Webbsida för begagnade fotbollsskor, knäskydd och målvaktshandskar." />
            </Helmet>
            <h1 className="Advertisment_title">Fotboll</h1>
            <h3 className="Advertisment_subtitle">Här finns det fotbollsutrustning som fotbollsskor, skydd och kläder. Är sidan tom finns det inga annonser för tillfället.</h3>
