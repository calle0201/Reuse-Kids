...
class Gymnastics extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/gymnastics.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
    ...
    render() {
      return (
        <div>
             <Helmet>
                <title>Begagnad gymnastikutrustning </title>
                <meta name="description" content="Webbsida för begagnade gymnastikmattor, trampett och gymnastikkläder." />
            </Helmet>
        <h1 className="Advertisment_title">Gymnastik</h1>
        <h3 className="Advertisment_subtitle">Här finns det gymnastikutrustning som kläder och mattor. Är sidan tom finns det inga annonser för tillfället.</h3>
