...
class Icehockey extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/icehockey.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
        ...
        render() {
            ...
            return (
                <div>
                     <Helmet>
                        <title>Begagnad ishockeyutrustning </title>
                        <meta name="description" content="Webbsida för begagnade hockeyskridskor, hockeyskydd, hockeyklubba, hockeybag och hockeyhjälm." />
                    </Helmet>
                <h1 className="Advertisment_title">Ishockey</h1>
                <h3 className="Advertisment_subtitle">Här finns det ishockeyutrustning som ishockeyskridskor, hjälmar och skydd. Är sidan tom finns det inga annonser för tillfället.</h3>
