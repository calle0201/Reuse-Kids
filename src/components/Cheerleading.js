...
class Cheerleading extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/cheerleading.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
        ...
        render() {
            ...
            return (
                <div>
                     <Helmet>
                        <title>Begagnad cheerleadingutrustning  </title>
                        <meta name="description" content="Webbsida för begagnade chearleadingskor, bows, rosetter, chearleadingkläder" />
                    </Helmet>
                <h1 className="Advertisment_title">Cheerleading</h1>
                <h3 className="Advertisment_subtitle">Här finns det cheerleadingutrustning som skor, kläder och accessoarer. Är sidan tom finns det inga annonser för tillfället.</h3>
