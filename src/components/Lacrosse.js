...
class Lacrosse extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/lacrosse.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
    ...
    render() {
      return (
        <div>
             <Helmet>
                <title>Begagnad lacrosseutrustning </title>
                <meta name="description" content="Webbsida för begagnad lacrossehjälm, lacrossestick, lacrosseklubba och lacrosseskydd." />
            </Helmet>
            <h1 className="Advertisment_title">Lacrosse</h1>
            <h3 className="Advertisment_subtitle">Här finns det lacrosseutrustning som lacrossestick, lacrossehjälmar och skydd. Är sidan tom finns det inga annonser för tillfället.</h3>
