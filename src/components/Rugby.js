...
class Rugby extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/rugby.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
        ...
        render() {
            ...
            return (
                <div>
                     <Helmet>
                        <title>Begagnad rugbyutrustning </title>
                        <meta name="description" content="Webbsida för begagnade rugbyskor, rugbyhjälm, axelskydd och rugbykläder." />
                    </Helmet>
                <h1 className="Advertisment_title">Rugby</h1>
                <h3 className="Advertisment_subtitle">Här finns det rugbyutrustning som skor, kläder och skydd. Är sidan tom finns det inga annonser för tillfället.</h3>
