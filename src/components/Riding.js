...
class Riding extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://reusesport.se/APIs/riding.php', obj)
        .then(res => {
            if (res.ok) {
              return res.json();
            } else {
    ...
    render() {
      return (
        ...
        <h1 className="Advertisment_title">Ridning</h1>
        <h3 className="Advertisment_subtitle">Här finns det ridutrustning som ridskor, ridkläder, skydd och utrustning till hästarna. Är sidan tom finns det inga annonser för tillfället.</h3>
